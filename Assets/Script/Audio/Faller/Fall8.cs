...
public class Fall8 : MonoBehaviour
{
    ...
    void Start()
    {
        target = GameObject.FindGameObjectWithTag("obj8").transform;
    ...
    void OnDestroy()
    {
        target.localScale = GameObject.FindGameObjectWithTag("objBase").GetComponent<GreatHantei>().defaultSize;
    }*/
}
